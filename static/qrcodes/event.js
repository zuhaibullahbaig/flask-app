...
function createQRcode(){
    ...
    event_name = String(document.getElementById('name').value);
    event_date = String(document.getElementById('date').value);
    event_location = String(document.getElementById('location').value);
